...
void loadMath()
{
        ...
        impl::registerVectorUserType<int32_t>("ivec");
        impl::registerVectorUserType<uint32_t>("uvec");

        impl::registerRectangleUserType<float>("rect");
        impl::registerRectangleUserType<int32_t>("irect");
        impl::registerRectangleUserType<uint32_t>("urect");

        impl::registerMatrixUserType<float>("mat");
        impl::registerMatrixUserType<int32_t>("imat");
        impl::registerMatrixUserType<uint32_t>("umat");
}
